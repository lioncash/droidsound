...
/* es */ {IDGS_PLAYBACK_ERROR_DIFFERENT_ES, "Error de reproduccion: %s diferente desde linea %d del fichero de depuracion%06d"},
...
/* ko */ {IDGS_CANNOT_CREATE_IMAGE_KO, "AI1IAo AAAIAÅ‚ Å‚y?oCO?o ?o?AÅLIÅLU!"},
/* nl */ {IDGS_CANNOT_CREATE_IMAGE_NL, "Kan bestand niet maken!"},
/* pl */ {IDGS_CANNOT_CREATE_IMAGE_PL, "Nie mo?na utworzya pliku obrazu!"},
/* ru */ {IDGS_CANNOT_CREATE_IMAGE_RU, "?O aODOaai aTÅ~ODai aDUU TNaDÅ~D!"},
...
/* es */ {IDGS_CANT_FIND_SECTION_END_SNAP_ES, "No puedo encontrar seccion eventos en fin fichero volcado memoria."},
...
/* es */ {IDGS_SORRY_NO_MULTI_RECORDING_ES, "Lo siento, no estan soportadas las grabaciones multiples."},
...
/* es */ {IDGS_WRITE_TO_SOUND_DEVICE_FAILED_ES, "Fallo en grabacion periferico sonido."},
...
/* es */ {IDGS_INIT_FAILED_FOR_DEVICE_S_ES, "Fallo inicializacion para periferico `%s'."},
...
/* es */ {IDGS_DEVICE_S_NOT_FOUND_SUPPORT_ES, "Periferico '%s' no encontrado o soportado."},
...
/* es */ {IDGS_RECORD_DEVICE_S_NOT_EXIST_ES, "No existe el periferico %s de grabacion "},
...
/* es */ {IDGS_RECORD_DIFFERENT_PLAYBACK_ES, "Periferico de grabacion y reproduccion tienen que ser diferentes"},
...
/* ru */ {IDGS_RECORD_DIFFERENT_PLAYBACK_RU, "AaaaTUaaOT Å~DsOaO OTUOYT TaUOcDaiai Ta aaaaTUaaOD OTasaTOÅ~OOOOYOi"},
...
/* es */ {IDGS_WARNING_RECORDING_REALTIME_ES, "!Precaucion! periferico de grabacion %s parece ser un periferico en tiempo real"},
...
/* es */ {IDGS_RECORD_NOT_SUPPORT_SOUND_PAR_ES, "El periferico de grabacion no soporta los actuales parametros de sonido"},
...
/* es */ {IDGS_FRAGMENT_PROBLEMS_ES, "Problema de fragmentacion"},
...
/* es */ {IDGS_STORE_SOUNDDEVICE_FAILED_ES, "Almacenamiento en periferico de sonido fallido"},
...
/* es */ {IDGS_SERVER_IS_WAITING_FOR_CLIENT_ES, "El servidor esta esperando al cliente..."},
...
/* es */ {IDGS_CANNOT_CONNECT_TO_S_ES, "No puedo conectar a  %s (Ninguun servidor en puerto %d)."},
...
/* ru */ {IDGS_FFMPEG_CANNOT_OPEN_VSTREAM_RU, "ffmpegdrv: ?O aODOaai TaUaeai OOOOT sTaTU"},
...
/* ru */ {IDGS_FFMPEG_CANNOT_OPEN_ASTREAM_RU, "ffmpegdrv: ?O aODOaai TaUaeai DaOOT sTaTU"},
...
/* es */ {IDGS_IO_READ_COLL_AT_X_FROM_ES, "Entrada/Salida real colision en %X para"},
...
/* es */ {IDGS_ALL_DEVICES_DETACHED_ES, ".\nTodos los perifericos nombrados seran desconectados."},
...
/* ru */ {IDGS_NO_FILENAME_RU, "?Oa OUOYO aDUUD!"},
...
/* es */ {IDGS_DTV_ROM_CREATED_ES, "Imagen DTV ROM creada con exito"},
...
/* ru */ {IDGS_DTV_ROM_CREATED_RU, "?NaDÅ~ DTV ROM aTÅ~ODY aasOeYT"},
...
/* es */ {IDGS_ABBREVIATION_S_ES, "Abreviacion: %s\n"},
...
/* es */ {IDGS_MACHINE_STATE_COMMANDS_ES, "Comandos estado maquina:"},
...
/* es */ {IDGS_MON_BACKTRACE_DESCRIPTION_ES, "Imprimir cadena de llamada JSR (la llamada mas reciente primero). Stack offset\nrelativo a  SP+1 se imprime entre parentesis. Esta es una buena suposicion\nsolo."},
...
/* es */ {IDGS_MON_CPUHISTORY_DESCRIPTION_ES, "Show <contador> ultimo comando ejecutado."},
...
/* es */ {IDGS_MON_DUMP_DESCRIPTION_ES, "Grabar volcado memoria de la maquina en el fichero especificado.\nEste volvado es compatible con el volcado grabado por el UI.\nNota: no se vuelca ninguna  imagen ROM."},
...
/* es */ {IDGS_MON_GOTO_DESCRIPTION_ES, "Cambiar el  PC con direccion y continuar la ejecucion"},
...
/* ru */ {IDGS_MON_GOTO_DESCRIPTION_RU, "ÅEDUOYOai ?o YD ÅãÅLAÉ A O saTOTUOOai OesTUYOYOO"},
...
/* es */ {IDGS_MON_IO_DESCRIPTION_ES, "Imprimir el area de entrada/salida de la maquina emulada."},
...
/* es */ {IDGS_MON_EXPORT_DESCRIPTION_ES, "Imprimir lista perifericos insertados en puertos de expansion."},
...
/* es */ {IDGS_MON_NEXT_DESCRIPTION_ES, "Avanzar a la siguiente instruccion.  Subrutinas seran tratadas como\ninstrucciones simples."},
...
/* es */ {IDGS_MON_RESET_DESCRIPTION_ES, "Reiniciar maquina o unidad disco. Tipo: 0 = soft, 1 = hard, 8-11 = unidad disco."},
...
/* es */ {IDGS_MON_RETURN_DESCRIPTION_ES, "Continuar ejecucion y volver al monitor justo antes que la siguiente\nRTS o RTI sea ejecutada."},
...
/* ru */ {IDGS_MON_SCREEN_DESCRIPTION_RU, "?aTNaDODOa aTOOaODYOO iUaDYD."},
...
/* es */ {IDGS_MON_STEP_DESCRIPTION_ES, "Salto simple a traves de la instruccion.  el CONTADOR permite el salto de\nmas de una instruccion a la vez."},
...
/* de */ {IDGS_MON_STOPWATCH_DESCRIPTION_DE, "Zeige CPU Zykluszahler des aktuellen Gerats. 'reset' setzt den Zahler\nauf 0."},
/* es */ {IDGS_MON_STOPWATCH_DESCRIPTION_ES, "Imprimir contador de ciclos del periferico actual. 'reset' pone el contador a 0."},
...
/* pl */ {IDGS_MON_STOPWATCH_DESCRIPTION_PL, "Poka? licznik cykli CPU obecnego urzÅ}dzenia. 'reset' zeruje licznik."},
...
/* es */ {IDGS_MON_UNDUMP_DESCRIPTION_ES, "Leer volcado memoria de una maquina desde el fichero especificado."},
...
/* es */ {IDGS_SYMBOL_TABLE_COMMANDS_ES, "Tabla simbolo comando:"},
...
/* es */ {IDGS_MON_ADD_LABEL_DESCRIPTION_ES, "<espacio memoria> es uno de: C: 8: 9: 10: 11:\n<direccion>  es la direccion donde estara la etiquetal.\n<letiqueta>   es el nombre de la etiqueta; debe empezar con un punto (\".\").\n\nMapea la direccion dada a una etiqueta que se usara cuando se inserte\ncodigo ensamblador y se mostrara durante el desensamblado.  Adicionalmente\npuede ser usada siempre que se deba especificar una direccion."},
...
/* es */ {IDGS_MON_WRITE_DESCRIPTION_ES, "Grabar el dato especificado en `direccion'."},
...
/* es */ {IDGS_INSTRUCTION_ES, "Insturccion"},
...
/* es */ {IDGS_MON_ASSEMBLE_DESCRIPTION_ES, "Ensambla instrucciones en la direccion especificada.  Si solo se\nespecifica una instruccion, entra en modo ensamblador, (entrar \nuna linea vacia para salir)."},
...
/* es */ {IDGS_ADDRESS_RANGE_ES, "Rango de direccion"},
...
/* tr */ {IDGS_ADDRESS_RANGE_TR, "adres_aralydy"},
#endif
...
/* es */ {IDGS_MON_COMPARE_DESCRIPTION_ES, "Compara memoria desde la fuente especificada por el rango de direcciones\ndestino. La region puede estar superpuesta. Cualquier valor diferente se\nmostrara usando el tipo de pantalla por defecto."},
...
/* es */ {IDGS_CHECKNUM_ES, "numero comprobacion"},
...
/* es */ {IDGS_MON_DELETE_DESCRIPTION_ES, "Borrar punto comprobacion `numero comprobacion'."},
...
/* es */ {IDGS_MON_DISASS_DESCRIPTION_ES, "Desensamblar instrucciones. Si se especifican dos direcciones, se\nusan como direcciones de inicio y final. Si solo se suministra una, sera\ntratada como direccion de inicio y un numero por defecto de  instrucciones\nseran desensambladas. Si no se especifica ninguna direccion, un numero\npor defecto de instrucciones se desensamblaran desde la direccion pre\ndefinida"},
...
/* es */ {IDGS_ADDRESS_OPT_RANGE_ES, "Rango direccion"},
...
/* es */ {IDGS_MON_II_DESCRIPTION_ES, "Mostrar contenidos de memoria con codigo texto pantalla."},
...
/* es */ {IDGS_MON_MEM_DESCRIPTION_ES, "Mostrar el contenido de memoria. Si no se da tipo de datos, se usa el\npor defecto. Si solo se da una direccion, la longitud de dato\nmostrado se basa en el tipo dato. Si no se dan direcciones, se \nusa la direccion 'dot'Por favor, note que debido al ambiguo significado de 'b' y 'd' estos\ntipos de dato se mostrararn en mayusculas."},
...
/* es */ {IDGS_MON_MEMCHAR_DESCRIPTION_ES, "Mostrar el contenido de memoria como datos de caracter. Si solo se una\ndireccion es especificada, solo se muestra un caracter. Si no se da\nninguna direccion, se usa la direccion 'dot'."},
...
/* es */ {IDGS_MON_MEMMAPSAVE_DESCRIPTION_ES, "Graba mapa memoria como grafico. el formato es:\n0 = BMP, 1 = PCX, 2 = PNG, 3 = GIF, 4 = IFF."},
...
/* es */ {IDGS_MON_MEMSPRITE_DESCRIPTION_ES, "Mostrar el contenido de memoria como datos de sprites, Si solo se \nespecifica una direccion, solo se muestra un sprite. Si no se dan\ndirecciones, se usa la direccion 'dot'."},
...
/* es */ {IDGS_MON_BREAK_DESCRIPTION_ES, "Poner punto de ruptura. Si no se da direccion, se imprime el actual punto\nde control. Si se da una direccion, se activa un punto de ruptura en la misma\ny se imprime el numero de punto de ruptura.\n`load|store|exec' es cualquiera de `load', `store' or `exec' (o combinacion\nde ellos) a especificar en que operacion el monitor se detiene. Si no se\nespecifica, el monitor se detiene en `exec'.\nSe puede especificar tambien una condicion para el punto de ruptura.\nPara mas informacion sobre condiciones, ver el comandoa CONDITION."},
/* fr */ {IDGS_MON_BREAK_DESCRIPTION_FR, ""},  /* fuzzy */
/* hu */ {IDGS_MON_BREAK_DESCRIPTION_HU, ""},  /* fuzzy */
/* it */ {IDGS_MON_BREAK_DESCRIPTION_IT, "Imposta un breakpoint. Se non viene specificato alcun indirizzo,\nvengono stampati i breakpoint attuali.\nSe viene specificato un indirizzo, viene impostato un breakpoint\nper tale indirizzo e viene stampato il suo numero.\n`load|store|exec' e uno tra `load', `store' o `exec' (or una qualunque\ncombinazione di questi) per specificare su quale operazione il monitor\ninterrompera. Se non specificato, il monitor interrompe su `exec'.\nPuo anche essere specificata una condizione per il breakpoint.\nPer ulteriori informazioni, vedere il comando CONDITION."},
...
/* sv */ {IDGS_MON_BREAK_DESCRIPTION_SV, "Satt en overvakningspunkt, Om ingen adress anges visas de \novervakningspunkter som ar giltiga.\nOm en adress anges satts en brytpunkt pa den adressen och dess\nnummer visas.\n\"load|store|exec\" ar antingen \"load\", \"store\" eller \"exec\"\n(eller en kombination darutav) for att ange pa vilken operation\nmonitorn stoppar. Om det inte anges bryter monitorn pa \"exec\".\nEtt villkorsuttryck kan ocksa anges for brytpunkten.\nFor mer information om villkor, se kommandot CONDITION."},
/* tr */ {IDGS_MON_BREAK_DESCRIPTION_TR, "Kesme noktasy koy, eder adres girilmemitse, gecerli mevcut izleme\nnoktalary yazdyrylyr.\nEder bir adres girilmitse, o adres icin bir kesme noktasy itaretlenir\nve kesme noktasy sayysy yazdyrylyr.\n`yukle|depola|yurut' icin `yukle', `depola' ya da `yurut' (ya da herhangi\nbir kombinasyonu) takip edilmek istenen operasyona gore belirtilmelidir.\nEder belirtilmemitse, takip itlemi `yurut'de sona erer.\nAyny zamanda kesme noktasy icin bir kotul ifadesi de belirtilebilir.\nKotullar ile ilgili daha cok bilgi almak icin, CONDITION komutuna\nbakabilirsiniz."},
#endif
...
/* es */ {IDGS_MON_CONDITION_DESCRIPTION_ES, "Cada vez que un punto de control se examine, la condicion se\nevaluara. Si la condicion es cierta, se activa el punto de control.\nSi no, se ignora. Si los registros estan especificado en la condicion,\nse usan los valores en el momento en el que se examina el punto\nde ruptura, no en el momento de poner la condicion.\nLa condicion puede usar los registros (.A, .X, .Y, .PC, .SP)  y compararlos\nm (==, !=, <, >, <=, >=) con otros registros y constantes.\nLos registros pueden ser de otros perifericos, esto se denota por el\nprefijo de espacio memoria (ejm., c:, 8:, 9:, 10:, 11:\nEjemplos: .A == 0, .X == .Y, 8:.X == .X\n"},
...
/* es */ {IDGS_MON_DISABLE_DESCRIPTION_ES, "Deshabilitar punto controlt `numero control'."},
...
/* es */ {IDGS_MON_ENABLE_DESCRIPTION_ES, "Habilitar punto controlt `numero control'."},
...
/* es */ {IDGS_MON_UNTIL_DESCRIPTION_ES, "Si no se da direccion, se imprime el ultimo punto de ruptura valido.\nSi se da direccion, se activa un punto de ruptura para la direccion\ny se imprime el numero del punto de ruptura. El control se devuelve al\nemulador por el comando. El punto de ruputa se borra una vez se encuentra."},
...
/* sv */ {IDGS_MON_WATCH_DESCRIPTION_SV, "Satt en overvakningspunkt. Om du inte anger nagon adress, visas\nnu giltiga overvakningspunkter. Om du anger en ensam adress satts en\novervakningspunkt for adressen. Om tva adresser anges satts en\novervakningspunkt for minnesomradet mellan adresserna.\n\"load|store|exec\" ar antingen \"load\". \"store\" eller \"exec\" (eller en\nkombination darutav) och anger vilken operation monitorn skall\nstoppa for. Om den inte anges stoppar emulatorn pa bade \"load\" och\n\"store\".\n"},
/* tr */ {IDGS_MON_WATCH_DESCRIPTION_TR, "Bir goruntuleme noktasy koy. Eder hic adres verilmemitse, mevcut gecerli\ngoruntuleme noktalary yazdyrylyr. Eder tek bir adres belirtilmitse,\ngoruntuleme noktasyny o adrese koy.  Eder iki adres belirtilmitse, goruntuleme\nnoktasyny o iki adres arasynda kalan adreslere koy.\n`yukle|depola|yurut' monitorun kesildidi operatore badly olarak `yukle'\n`depola' ya da `yurut' (ya da herhangi bir kombinasyonunda) itlemlerinde\ncalytabilir. Eder belirtilmemitse, monitor `yukle' ve `depola'da kesilecektir.\n"},
#endif
...
/* sv */ {IDGS_MON_TRACE_DESCRIPTION_SV, "Satt en sparningspunkt. Om ingen adress anges visas befintliga\nsparningspunkter. Om du anger en ensam adress satts en sparningspunkt\nfor adressen. Om tva adresser anges satts en sparningspunkt for\nminnesomradet mellan adresserna.\n\"load|store|exec\" ar antingen \"load\", \"store\" eller \"exec\" (eller en\nkombination darutav) och anger vilken operation monitorn skall stoppa\nfor. Om den inte anges sparar monitorn alla tre operationerna.\n"},
/* tr */ {IDGS_MON_TRACE_DESCRIPTION_TR, "Bir izleme noktasy koy. Eder bir adres belirtilmemitse, mevcut gecerli\nizleme noktalary yazdyrylyr. Eder tek bir adres belirtilmitse, izleme\nnoktasyny o adrese koy.  Eder iki adres belirtilmitse, izleme noktasyny\no iki adres arasynda kalan adreslere koy.\n`yukle|depola|yurut' monitorun kesildidi operatore badly olarak `yukle'\n`depola' ya da `yurut' (ya da herhangi bir kombinasyonunda) itlemlerinde\ncalytabilir. Eder belirtilmemitse, monitor her uc itlemi de izleyecektir.\n"},
#endif
...
/* es */ {IDGS_MON_DEVICE_DESCRIPTION_ES, "Seleccionar el periferico memoria por defecto entre  `c:' o la\nunidad de disco especificada (`8:', `9:')."},
...
/* es */ {IDGS_MON_EXIT_DESCRIPTION_ES, "Dejar el monitor y volver a la ejecucion."},
...
/* ru */ {IDGS_MON_QUIT_DESCRIPTION_RU, "2eUaO OÅ~ iUaUiaTaD YOUOOUOYYT."},
...
/* es */ {IDGS_MON_RADIX_DESCRIPTION_ES, "Seleccionar sistema numerico por defecto como hex, decimal, octal, o binario.\nSi no se da argumento, se imprime el sistema numerico en uso."},
...
/* es */ {IDGS_MON_SIDEFX_DESCRIPTION_ES, "Controla como manejar las lecturas de localizaciones de memoria generadas por el\nmonitor que tengan efectos colaterales, Si el argumento es 'on' las lecturas causaran\nefectos colaterales. Si el argumento es 'off' no se causaran efectos colaterales. Si el\nargumento es 'intercambiar' se intervambiara el modo en uso. Sin argumentos, se \nmostrara el estado en uso."},
...
/* es */ {IDGS_FILE_INDEX_ES, "Indice de fichero"},
...
/* es */ {IDGS_MON_AUTOSTART_DESCRIPTION_ES, "Autoarranque imagen de disco/cinta o programa"},
...
/* tr */ {IDGS_MON_AUTOSTART_DESCRIPTION_TR, "verilen disk/teyp imajyny ya da programy otomatik batlat"},
#endif
...
/* es */ {IDGS_MON_AUTOLOAD_DESCRIPTION_ES, "Autocarga imagen de disco/cinta o programa"},
...
/* tr */ {IDGS_MON_AUTOLOAD_DESCRIPTION_TR, "verilen disk/teyp imajyny ya da programy otomatik yuklet"},
#endif
...
/* es */ {IDGS_MON_ATTACH_DESCRIPTION_ES, "Inserta fichero en periferico (periferico 32=cartucho)"},
...
/* es */ {IDGS_MON_BLOAD_DESCRIPTION_ES, "Cargar el fichero especificado en memoria en la direcccion indicada en\ndireccion. Si el periferico es 0 el fichero se lee desde sistema."},
...
/* es */ {IDGS_MON_BLOCK_READ_DESCRIPTION_ES, "Leer bloque en la pista y sector especificados. Si la direccion se\nespecifica, el dato se carga en memoria, si no, el dato se muestra\nusando el tipo dato por defecto."},
...
/* es */ {IDGS_MON_BSAVE_DESCRIPTION_ES, "Grabar la memoria entre direccion 1 y direccion2 al fichero indicado.\nSi el periferico es 0, el fichero se graba en el fichero del sistema."},
...
/* es */ {IDGS_MON_BLOCK_WRITE_DESCRIPTION_ES, "Grabar un bloque de datos en 'direccion' en la pista y sector indicados\ndel disco en la unidad de discos 8."},
...
/* ru */ {IDGS_MON_CD_DESCRIPTION_RU, "AUOYOai aOUaeai aDNTcai OOaOUaTaOi."},
/* sv */ {IDGS_MON_CD_DESCRIPTION_SV, "Andra aktuell arbetskatalog"},
/* tr */ {IDGS_MON_CD_DESCRIPTION_TR, "Gecerli calytma dizinini dedittir."},
#endif
...
/* es */ {IDGS_MON_DETACH_DESCRIPTION_ES, "Extraer fichero desde el periferico (periferico 32 = cartucho)"},
...
/* ru */ {IDGS_MON_DIR_DESCRIPTION_RU, "?aTNaDÅ~Oai aTOOaODYOO OOaOUaTaOO."},
...
/* es */ {IDGS_MON_LOAD_DESCRIPTION_ES, "Cargar el fichero especificado en la direccion de memoria indicada. Actualizar\npunteros BASIC apropiadamente si se carga en la memoria del ordenador\n(no en todos los emuladores).\nUsar direccion de dos bytes del fichero si no se indica otra direccion.\nSi el periferico es 0, el fichero se lee del sistema."},
...
/* ru */ {IDGS_MON_PWD_DESCRIPTION_RU, "?aTNaDÅ~Oai aOUaeai aDNTcai OOaOUaTaOi."},
...
/* es */ {IDGS_MON_SAVE_DESCRIPTION_ES, "Graba memoria entre direccion1 y direccion2 al fichero indicado.\nGraba direccion de carga de dos bytes.\nSi el periferico es 0, se graba en el sistema."},
...
/* ru */ {IDGS_OTHER_COMMANDS_RU, "ÅLaaOOO UTUDYOe:"},
...
/* es */ {IDGS_MON_CARTFREEZE_DESCRIPTION_ES, "Usar congelacion cartucho"},
...
/* es */ {IDGS_EXPRESSION_ES, "expresion"},
...
/* es */ {IDGS_MON_PRINT_DESCRIPTION_ES, "Evaluar la expresion y mostrar los resultados."},
...
/* es */ {IDGS_MON_STOP_DESCRIPTION_ES, "Detener comando de grabacion. Ver 'grabacion'"},
...
/* es */ {IDCLS_ENABLE_AUTOSTART_HANDLE_TDE_ES, "Manejar en autoarranque emulacion de disco verdadera"},
...
/* es */ {IDCLS_DISABLE_AUTOSTART_HANDLE_TDE_ES, "No manejar en autoarranque emulacion de disco verdadera"},
...
/* es */ {IDCLS_ENABLE_WARP_MODE_AUTOSTART_ES, "Permitir modo ultrarapido durante autoarranque"},
...
/* es */ {IDCLS_DISABLE_WARP_MODE_AUTOSTART_ES, "Deshabilitar modo ultrarapido durante autoarranque"},
...
/* sv */ {IDCLS_SET_AUTOSTART_DELAY_SV, "Ange inledande fordrojning for autostart (0: anvand standard)"},
/* tr */ {IDCLS_SET_AUTOSTART_DELAY_TR, "Otomatik batlatmada rastgele gecikmeyi ayarla (0: varsayylany kullan)"},
#endif
...
/* sv */ {IDCLS_ENABLE_AUTOSTART_RANDOM_DELAY_SV, "Aktivera slumpmassig inledande autostartfordrojning"},
/* tr */ {IDCLS_ENABLE_AUTOSTART_RANDOM_DELAY_TR, "Otomatik batlatmada rastgele gecikmeyi aktif et"},
#endif
...
/* sv */ {IDCLS_DISABLE_AUTOSTART_RANDOM_DELAY_SV, "Inaktivera slumpmassig inledande autostartfordrojning"},
/* tr */ {IDCLS_DISABLE_AUTOSTART_RANDOM_DELAY_TR, "Otomatik batlatmada rastgele gecikmeyi pasiflettir"},
#endif
...
/* es */ {IDCLS_USE_PAL_SYNC_FACTOR_ES, "Usar factor sincronizacion PAL"},
...
/* es */ {IDCLS_USE_PALN_SYNC_FACTOR_ES, "Usar factor sincronizacion PAL-N"},
...
/* es */ {IDCLS_SET_BURST_MOD_ES, "Modificacion arranque (0=No, 1=CIA1, 2=CIA2)"},
...
/* tr */ {IDCLS_SET_BURST_MOD_TR, "Burst deditiklidi (0 = Yok, 1 = CIA1, 2 = CIA2)"},
#endif
...
/* es */ {IDCLS_SPECIFY_DE_KERNEL_NAME_ES, "Especificar nombre imagen ROM Kernal aleman"},
...
/* es */ {IDCLS_SPECIFY_FI_KERNEL_NAME_ES, "Especificar nombre imagen ROM Kernal finlandes"},
...
/* es */ {IDCLS_SPECIFY_FR_KERNEL_NAME_ES, "Especificar nombre imagen ROM Kernal frances"},
...
/* es */ {IDCLS_SPECIFY_DE_CHARGEN_ROM_NAME_ES, "Especificar nombre imagen ROM generador caracteres aleman"},
...
/* ru */ {IDCLS_SPECIFY_DE_CHARGEN_ROM_NAME_RU, "AUDÅ~Dai OUi ROM TNaDÅ~D OOYOaDaTaD YOUOaUOa aOUOTUTO"},
...
/* es */ {IDCLS_SPECIFY_FR_CHARGEN_ROM_NAME_ES, "Especificar nombre imagen ROM generador caracteres frances"},
...
/* ru */ {IDCLS_SPECIFY_FR_CHARGEN_ROM_NAME_RU, "AUDÅ~Dai OUi ROM TNaDÅ~D OOYOaDaTaD aaDYaaÅ~aUOa aOUOTUTO"},
...
/* ru */ {IDCLS_SPECIFY_SV_CHARGEN_ROM_NAME_RU, "AUDÅ~Dai OUi ROM TNaDÅ~D OOYOaDaTaD eOOOaUOa aOUOTUTO"},
...
/* ru */ {IDCLS_SPECIFY_C64_MODE_BASIC_NAME_RU, "AUDÅ~Dai OUi ROM TNaDÅ~D aOOOUD C64 BASIC"},
...
/* es */ {IDCLS_ENABLE_IEE488_ES, "Permitir emulacion interface IEEE488"},
...
/* es */ {IDCLS_DISABLE_IEE488_ES, "Deshabilitar emulacion interface IEEE488"},
...
/* es */ {IDCLS_P_REVISION_ES, "<Revision>"},
...
/* es */ {IDCLS_PATCH_KERNAL_TO_REVISION_ES, "Parchear la ROM Kernal a la version <revision>"},
...
/* es */ {IDCLS_ENABLE_DEXX_ACIA_RS232_EMU_ES, "Permitir emulacion interface ACIA RS232"},
...
/* tr */ {IDCLS_ENABLE_DEXX_ACIA_RS232_EMU_TR, "ACIA RS232 arabirim emulasyonunu aktif et"},
#endif
...
/* es */ {IDCLS_DISABLE_DEXX_ACIA_RS232_EMU_ES, "Deshabilitar emulacion interface ACIA RS232"},
...
/* tr */ {IDCLS_DISABLE_DEXX_ACIA_RS232_EMU_TR, "ACIA RS232 arabirim emulasyonunu pasiflettir"},
#endif
#endif
...
/* es */ {IDCLS_ENABLE_ACIA_EMU_ES, "Habilitar emulacion ACIA"},
...
/* tr */ {IDCLS_ENABLE_ACIA_EMU_TR, "ACIA emulasyonunu aktif et"},
#endif
...
/* es */ {IDCLS_DISABLE_ACIA_EMU_ES, "Deshabilitar emulacion ACIA"},
...
/* tr */ {IDCLS_DISABLE_ACIA_EMU_TR, "ACIA emulasyonunu pasiflettir"},
#endif
...
/* es */ {IDCLS_SPECIFY_KEYMAP_FILE_INDEX_ES, "Especificar indice del fichero mapa del teclado (0=simbolico, 1=posicional)"},
...
/* es */ {IDCLS_SPECIFY_SYM_KEYMAP_FILE_NAME_ES, "Especificar nombre fichero del mapa de teclado simbolico"},
...
/* ru */ {IDCLS_ACTIVATE_40_COL_MODE_RU, "ÅãUaOOOaTODai aOOOU 40 UTUTYTU"},
...
/* ru */ {IDCLS_ACTIVATE_80_COL_MODE_RU, "ÅãUaOOOaTODai aOOOU 80 UTUTYTU"},
...
/* it */ {IDCLS_GO64_MODE_IT, "Usa sempre in modalita C64 al reset"},
...
/* ru */ {IDCLS_GO128_MODE_RU, "2aOOOD sOaOUUicDai O aOOOU C128 sTaUO sOaOÅ~DsaaUD"},
...
/* es */ {IDCLS_SPECIFY_INT_FUNC_ROM_NAME_ES, "Especificar nombre imagen ROM funcion interna"},
...
/* es */ {IDCLS_SPECIFY_EXT_FUNC_ROM_NAME_ES, "Especificar nombre imagen ROM funcion externa"},
...
/* es */ {IDCLS_ENABLE_INT_FUNC_ROM_ES, "Permitir ROM funcion interna"},
...
/* pl */ {IDCLS_ENABLE_INT_FUNC_ROM_PL, "W3Å}cz wewnetrzny Function ROM"},
...
/* es */ {IDCLS_DISABLE_INT_FUNC_ROM_ES, "Deshabilitar ROM funcion interna"},
...
/* es */ {IDCLS_ENABLE_EXT_FUNC_ROM_ES, "Permitir ROM funcion externa"},
...
/* pl */ {IDCLS_ENABLE_EXT_FUNC_ROM_PL, "W3Å}cz zewnetrzny Function ROM"},
...
/* es */ {IDCLS_DISABLE_EXT_FUNC_ROM_ES, "Deshabilitar ROM funcion externa"},
...
/* es */ {IDCLS_USE_OLD_NTSC_SYNC_FACTOR_ES, "Usar antiguo factor de sincronizacion NTSC"},
...
/* de */ {IDCLS_SET_C128_MODEL_DE, "Wahle C128 Modell (c128/c128dcr, pal/ntsc)"},
...
/* sv */ {IDCLS_SET_C128_MODEL_SV, "Valj C128-modell (c128/c128dcr, pal/ntsc)"},
...
/* pl */ {IDCLS_SPECIFY_CHARGEN_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM tworzenia znakow"},
...
/* es */ {IDCLS_SPECIFY_INDEX_KEYMAP_FILE_0_2_ES, "Especificar indice fichero mapa teclado (0=sim, 1=simAL, 2=pos)"},
...
/* pl */ {IDCLS_SPECIFY_INDEX_KEYMAP_FILE_0_2_PL, "Podaj indeks dla uk3adu klawiatury (0=symbol, 1=symbolDE, 2=pozycja)"},
...
/* es */ {IDCLS_SPECIFY_NAME_SYM_DE_KEYMAP_ES, "Especificar nombre del fichero teclado simbolico aleman"},
...
/* es */ {IDCLS_SET_GLUE_LOGIC_TYPE_ES, "Seleccionar tipo de 'glue' logico (0 = discrete, 1 = 252535-01)"},
...
/* es */ {IDCLS_ENABLE_IEEE488_INTERFACE_ES, "Permitir emulacion interface IEEE488"},
...
/* es */ {IDCLS_DISABLE_IEEE488_INTERFACE_ES, "Deshabilitar emulacion interface IEEE488"},
...
/* es */ {IDCLS_ENABLE_GEORAM_ES, "Permitir unidad expansion GEO-RAM"},
...
/* tr */ {IDCLS_ENABLE_GEORAM_TR, "GEO-RAM genitletme birimini aktif et"},
#endif
...
/* es */ {IDCLS_DISABLE_GEORAM_ES, "Deshabilitar unidad expansion GEO-RAM"},
...
/* tr */ {IDCLS_DISABLE_GEORAM_TR, "GEO-RAM genitletme birimini pasiflettir"},
#endif
...
/* es */ {IDCLS_ALLOW_WRITING_TO_GEORAM_IMAGE_ES, "Permitir grabacion sobre imagen GEORAM"},
...
/* es */ {IDCLS_P_SIZE_IN_KB_ES, "<tamano en KB>"},
...
/* ru */ {IDCLS_P_SIZE_IN_KB_RU, "<aDÅ~UOa O oÅ}>"},
...
/* es */ {IDCLS_GEORAM_SIZE_ES, "Tamano de la unidad expansion GEORAM"},
...
/* es */ {IDCLS_ENABLE_PETREU_ES, "Permitir PET ram y Unidad Expansion"},
...
/* es */ {IDCLS_DISABLE_PETREU_ES, "Deshabilitar PET RAM y Unidad Expansion"},
...
/* es */ {IDCLS_SPECIFY_PETREU_NAME_ES, "Especificar nombre imagen PET Ram y Unidad Expansion"},
...
/* es */ {IDCLS_PETREU_SIZE_ES, "Tamano de PET Ram y Unidad Expansion"},
...
/* es */ {IDCLS_ENABLE_PETDWW_ES, "Permitir tablero de alta resolucion PET DWW"},
...
/* es */ {IDCLS_DISABLE_PETDWW_ES, "Deshabilitar tablero de alta resolucion PET DWW"},
...
/* es */ {IDCLS_SPECIFY_PSID_TUNE_NUMBER_ES, "Especificar PSID tono <numero>"},
...
/* es */ {IDCLS_ENABLE_RAMCART_ES, "Permitir expansion RAMCART"},
...
/* tr */ {IDCLS_ENABLE_RAMCART_TR, "RamCart genitlemesini aktif et"},
#endif
...
/* es */ {IDCLS_DISABLE_RAMCART_ES, "Deshabilitar expansion RamCart"},
...
/* pl */ {IDCLS_DISABLE_RAMCART_PL, "Wy3Å}cz rozszerzenie RamCart"},
/* ru */ {IDCLS_DISABLE_RAMCART_RU, "Disable the RamCart expansion"},
/* sv */ {IDCLS_DISABLE_RAMCART_SV, "Inaktivera RamCart-expansion"},
/* tr */ {IDCLS_DISABLE_RAMCART_TR, "RamCart genitlemesini pasiflettir"},
#endif
...
/* es */ {IDCLS_RAMCART_SIZE_ES, "Tamano expansion RAMCart"},
...
/* es */ {IDCLS_ALLOW_WRITING_TO_DQBB_IMAGE_ES, "Permitir grabacion en imagen DQBB "},
...
/* es */ {IDCLS_DO_NOT_WRITE_TO_DQBB_IMAGE_ES, "No permitir grabacion en imagen DQBB "},
...
/* tr */ {IDCLS_ENABLE_ISEPIC_TR, "ISEPIC kartutunu aktif et"},
#endif
...
/* tr */ {IDCLS_DISABLE_ISEPIC_TR, "ISEPIC kartutunu pasiflettir"},
#endif
...
/* es */ {IDCLS_ALLOW_WRITING_TO_ISEPIC_IMAGE_ES, "Permitir grabacion en imagen ISEPIC"},
...
/* es */ {IDCLS_DO_NOT_WRITE_TO_ISEPIC_IMAGE_ES, "No permitir grabacion en imagen ISEPIC"},
...
/* es */ {IDCLS_ENABLE_MMC64_ES, "Permitir expansion MMC64"},
...
/* es */ {IDCLS_DISABLE_MMC64_ES, "Deshabilitar expansion MMC64"},
...
/* es */ {IDCLS_MMC64_READONLY_ES, "Seleccionar tarjeta MMC64 en modo solo lectura"},
...
/* es */ {IDCLS_MMC64_READWRITE_ES, "Seleccionar tarjeta MMC64 en modo lectura/grabacion"},
...
/* es */ {IDCLS_MMC_REPLAY_CARD_WRITE_ENABLE_ES, "Permitir grabacion en imagen tarjeta MMC Replay"},
...
/* es */ {IDCLS_MMC_REPLAY_CARD_WRITE_DISABLE_ES, "Deshabilitar grabacion en imagen tarjeta MMC Replay"},
...
/* es */ {IDCLS_MMC_REPLAY_EEPROM_WRITE_ENABLE_ES, "Permitir grabacion en imagen EEPROM MMC Replay"},
...
/* es */ {IDCLS_MMC_REPLAY_EEPROM_WRITE_DISABLE_ES, "Deshabilitar grabacion en imagen EEPROM MMC Replay"},
...
/* es */ {IDCLS_ALLOW_WRITING_TO_MMC_REPLAY_IMAGE_ES, "Permtir grabacion en imagen MMC Replay"},
...
/* tr */ {IDCLS_ENABLE_REU_TR, "RAM Genitletme Birimi'ni aktif et"},
#endif
...
/* tr */ {IDCLS_DISABLE_REU_TR, "RAM Genitletme Birimi'ni pasiflettir"},
#endif
...
/* es */ {IDCLS_REU_SIZE_ES, "Tamano unidad expansion RAM"},
...
/* es */ {IDCLS_TFE_INTERFACE_ES, "Seleccionar interface sistema ethernet para emulacion TFE"},
...
/* es */ {IDCLS_ENABLE_TFE_AS_RRNET_ES, "Permitir emulacion TFE en modo RRNet"},
...
/* es */ {IDCLS_DISABLE_TFE_AS_RRNET_ES, "Deshabilitar emulacion TFE en modo RRNet"},
...
/* es */ {IDCLS_CART_ATTACH_DETACH_RESET_ES, "Reiniciar maquina si un cartucho es insertado o extraido"},
...
/* pl */ {IDCLS_CART_ATTACH_DETACH_RESET_PL, "Resetuj maszyne przy zamontowaniu i odmontowaniu kartrid?a"},
...
/* es */ {IDCLS_CART_ATTACH_DETACH_NO_RESET_ES, "No reiniciar maquina si un cartucho es insertado o extraido"},
...
/* ko */ {IDCLS_ATTACH_CRT_CART_KO, "CRT AÅ·ARÅCRAo AI1IAoÅC| oU?c3OAÅC?A?A"},
...
/* ru */ {IDCLS_ATTACH_GENERIC_8KB_CART_RU, "?aOUaOsOai saTOUa TNaDÅ~D 8oN UDaaaOOOD"},
...
/* ru */ {IDCLS_ATTACH_GENERIC_16KB_CART_RU, "?aOUaOsOai saTOUa TNaDÅ~D 16oN UDaaaOOOD"},
...
/* ko */ {IDCLS_ATTACH_CBM_IEEE488_CART_KO, "IEEE-488 AIAIADAI?o AÅ·ARÅCRAo AI1IAoÅC| oU?c3OAÅC???a"},
...
/* sv */ {IDCLS_ATTACH_RAW_KINGSOFT_CART_SV, "Anslut ra 24kB-Kingsoft-insticksmodulfil"},
...
/* sv */ {IDCLS_ATTACH_RAW_PAGEFOX_CART_SV, "Anslut ra 64KB-Pagefox-insticksmodulavbilding"},
/* tr */ {IDCLS_ATTACH_RAW_PAGEFOX_CART_TR, "Duz 64KB Pagefox kartut imajy yerlettir"},
#endif
...
/* es */ {IDCLS_ALLOW_WRITING_TO_EXPERT_IMAGE_ES, "Permitir grabacion en Expert Cartridge"},
...
/* es */ {IDCLS_DO_NOT_WRITE_TO_EXPERT_IMAGE_ES, "Deshabilitar grabacion en Expert Cartridge"},
...
/* es */ {IDCLS_SET_AMOUNT_CYLINDERS_IDE64_ES, "Seleccionar numero de cilindros para emulacion IDE64"},
...
/* es */ {IDCLS_SET_AMOUNT_HEADS_IDE64_ES, "Seleccionar numero de cabezas para emulacion IDE64"},
...
/* es */ {IDCLS_SET_AMOUNT_SECTORS_IDE64_ES, "Seleccionar numero de sectores para emulacion IDE64"},
...
/* es */ {IDCLS_AUTODETECT_IDE64_GEOMETRY_ES, "Autodeteccion del tamano de la imagen"},
...
/* ru */ {IDCLS_AUTODETECT_IDE64_GEOMETRY_RU, "ÅãOaTUDaOcOaUTO TsaOOOUOYOO aDÅ~UOaD OÅ~TNaDOOYOi"},
...
/* es */ {IDCLS_IDE64_V4_ES, "Emular version 4 hardware"},
...
/* es */ {IDCLS_IDE64_PRE_V4_ES, "Emular preversion 4 hardware"},
...
/* es */ {IDCLS_P_MODELNUMBER_ES, "<numero modelo>"},
...
/* es */ {IDCLS_P_LINENUMBER_ES, "<numero linea>"},
...
/* es */ {IDCLS_P_RAMSIZE_ES, "<Tamano RAM>"},
...
/* es */ {IDCLS_SPECIFY_SIZE_OF_RAM_ES, "Especificar tamano RAM  (64/128/256/512/1024 KB)"},
...
/* es */ {IDCLS_SPECIFY_KEYMAP_INDEX_ES, "Especificar indice fichero teclado"},
...
/* es */ {IDCLS_SPECIFY_GFX_SYM_KEYMAP_NAME_ES, "Especificar nombre fichero graficos teclado simbolico"},
...
/* es */ {IDCLS_SPECIFY_BUK_SYM_KEYMAP_NAME_ES, "Especificar nombre fichero teclado UK business simbolico"},
...
/* es */ {IDCLS_SPECIFY_BDE_SYM_KEYMAP_NAME_ES, "Especificar nombre fichero teclado Aleman business simbolico"},
...
/* es */ {IDCLS_SPECIFY_BDE_POS_KEYMAP_NAME_ES, "Especificar nombre fichero teclado Aleman business posicional"},
...
/* de */ {IDCLS_ENABLE_DRIVE_SOUND_DE, "Sound Emulation fur Disklaufwerke aktivieren"},
/* es */ {IDCLS_ENABLE_DRIVE_SOUND_ES, "Permitir emulacion de sonido en unidad de discos"},
...
/* pl */ {IDCLS_ENABLE_DRIVE_SOUND_PL, "W3Å}cz emulacje odg3osow stacji dyskow"},
/* ru */ {IDCLS_ENABLE_DRIVE_SOUND_RU, ""},  /* fuzzy */
/* sv */ {IDCLS_ENABLE_DRIVE_SOUND_SV, "Aktivera ljudemulering for diskettstationer"},
/* tr */ {IDCLS_ENABLE_DRIVE_SOUND_TR, "Disk suruculerinin ses emulasyonunu aktif et"},
#endif
...
/* de */ {IDCLS_DISABLE_DRIVE_SOUND_DE, "Sound Emulation fur Disklaufwerke deaktivieren"},
/* es */ {IDCLS_DISABLE_DRIVE_SOUND_ES, "Inhabilitar emulacion de sonido wn unidad de discos"},
...
/* pl */ {IDCLS_DISABLE_DRIVE_SOUND_PL, "Wy3Å}cz emulacje odg3osow stacji dyskow"},
/* ru */ {IDCLS_DISABLE_DRIVE_SOUND_RU, ""},  /* fuzzy */
/* sv */ {IDCLS_DISABLE_DRIVE_SOUND_SV, "Inaktivera ljudemulering for diskettstationer"},
/* tr */ {IDCLS_DISABLE_DRIVE_SOUND_TR, "Disk suruculerinin ses emulasyonunu pasiflettir"},
#endif
...
/* es */ {IDCLS_OVERSIZED_HANDLING_ES, "Seleccionar como se manejaran las entradas sobredimensionadas, (0: escalar, 1:recorte sup izq, 2:recorte sup centro, 3:recorte sup dcha, 4:recorte centro izq, 5:recorte centro, 6:recorte centro dcha, 7:recorte abajo izq, 8:recorte centro abajo, 9:recorte abajo dcha)"},
...
/* es */ {IDCLS_MULTICOLOR_HANDLING_ES, "Seleccionar como se manejaran el cambio multicolor-alta resolucion (0:ByN, 1:2 colores, 2:4 colores, 3:escala grises, 4:mejores colores)"},
...
/* pl */ {IDCLS_MULTICOLOR_HANDLING_PL, "Wybiera sposob obs3ugi wielu kolorow w wysokiej rozdzielczoÅ˜ci (0: czarno-bia3y, 1: 2 kolory, 2: 4 kolory, 3: skala szaroÅ˜ci, 4: najlepsze kolory komorek)"},
...
/* es */ {IDCLS_TED_LUM_HANDLING_ES, "Seleccionar como se manejaran la luminosidad TED (0:ignorar, 1:dither)"},
...
/* es */ {IDCLS_CRTC_TEXT_COLOR_ES, "Seleccionar color texto CRTC (0:blanco, 1:ambar, 2:verde)"},
...
/* es */ {IDCLS_SET_DRIVE_EXTENSION_POLICY_ES, "Seleccionar politica unidad disco extension 40 pistas (0:nunca, 1:preguntar, 2:al acceder)"},
...
/* pl */ {IDCLS_SPECIFY_1541_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 1541"},
...
/* pl */ {IDCLS_SPECIFY_1541_II_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 1541-II"},
...
/* pl */ {IDCLS_SPECIFY_1570_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 1570"},
...
/* pl */ {IDCLS_SPECIFY_1571_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 1571"},
...
/* pl */ {IDCLS_SPECIFY_1581_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 1581"},
...
/* pl */ {IDCLS_SPECIFY_2000_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 2000"},
...
/* pl */ {IDCLS_SPECIFY_4000_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 4000"},
...
/* es */ {IDCLS_SET_IDLE_METHOD_ES, "Seleccionar metodo tiempo inactico (0: sin intercepcion, 1:saltar ciclos, 2:interceptar tiempos inactivos)"},
...
/* es */ {IDCLS_ENABLE_DRIVE_RAM_2000_ES, "Permitir expansion RAM de 8KB en $2000-$3FFF"},
...
/* es */ {IDCLS_DISABLE_DRIVE_RAM_2000_ES, "Deshabilitar expansion RAM de 8KB en $2000-$3FFF"},
...
/* es */ {IDCLS_ENABLE_DRIVE_RAM_4000_ES, "Permitir expansion RAM de 8KB en $4000-$5FFF"},
...
/* es */ {IDCLS_DISABLE_DRIVE_RAM_4000_ES, "Deshabilitar expansion RAM de 8KB en $4000-$5FFF"},
...
/* es */ {IDCLS_ENABLE_DRIVE_RAM_6000_ES, "Permitir expansion RAM de 8KB en $6000-$7FFF"},
...
/* es */ {IDCLS_DISABLE_DRIVE_RAM_6000_ES, "Deshabilitar expansion RAM de 8KB en $6000-$7FFF"},
...
/* es */ {IDCLS_ENABLE_DRIVE_RAM_8000_ES, "Permitir expansion RAM de 8KB en $8000-$9FFF"},
...
/* es */ {IDCLS_DISABLE_DRIVE_RAM_8000_ES, "Deshabilitar expansion RAM de 8KB en $8000-$9FFF"},
...
/* es */ {IDCLS_ENABLE_DRIVE_RAM_A000_ES, "Permitir expansion RAM de 8KB en $A000-$BFFF"},
...
/* es */ {IDCLS_DISABLE_DRIVE_RAM_A000_ES, "Deshabilitar expansion RAM de 8KB en $A000-$BFFF"},
...
/* pl */ {IDCLS_SPECIFY_1571CR_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 1571CR"},
...
/* pl */ {IDCLS_SPECIFY_2031_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 2031"},
...
/* pl */ {IDCLS_SPECIFY_2040_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 2040"},
...
/* pl */ {IDCLS_SPECIFY_3040_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 3040"},
...
/* pl */ {IDCLS_SPECIFY_4040_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 4040"},
...
/* pl */ {IDCLS_SPECIFY_1001_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 1001/8050/8250"},
...
/* pl */ {IDCLS_SPECIFY_1551_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM DOS-a 1551"},
...
/* es */ {IDCLS_USE_AS_DIRECTORY_FSDEVICE_8_ES, "Usar <nombre> como directorio fichero sistema periferico #8"},
...
/* es */ {IDCLS_USE_AS_DIRECTORY_FSDEVICE_9_ES, "Usar <nombre> como directorio fichero sistema periferico #9"},
...
/* es */ {IDCLS_USE_AS_DIRECTORY_FSDEVICE_10_ES, "Usar <nombre> como directorio fichero sistema periferico #10"},
...
/* es */ {IDCLS_USE_AS_DIRECTORY_FSDEVICE_11_ES, "Usar <nombre> como directorio fichero sistema periferico #10"},
...
/* es */ {IDCLS_SPECIFY_4K_ROM_9XXX_NAME_ES, "Especificar nombre extension ROM 4KB en $9***"},
...
/* es */ {IDCLS_SPECIFY_4K_ROM_AXXX_NAME_ES, "Especificar nombre extension ROM 4KB en $A***"},
...
/* es */ {IDCLS_SPECIFY_4K_ROM_BXXX_NAME_ES, "Especificar nombre extension ROM 4KB en $B***"},
...
/* pl */ {IDCLS_ENABLE_ROM_1_KERNAL_PATCHES_PL, "W3Å}cz 3atki Kernala ROM 1"},
...
/* pl */ {IDCLS_DISABLE_ROM_1_KERNAL_PATCHES_PL, "Wy3Å}cz 3atki Kernala ROM 1"},
...
/* es */ {IDCLS_SWITCH_UPPER_LOWER_CHARSET_ES, "Intercambiar mayusculas/minuscula"},
...
/* es */ {IDCLS_NO_SWITCH_UPPER_LOWER_CHARSET_ES, "No intercambiar mayusculas/minusculas"},
...
/* es */ {IDCLS_SPECIFY_FUNCTION_LOW_ROM_NAME_ES, "Especificar nombre imagen ROM funcion baja"},
...
/* es */ {IDCLS_SPECIFY_FUNCTION_HIGH_ROM_NAME_ES, "Especificar nombre imagen ROM funcion alta"},
...
/* es */ {IDCLS_SPECIFY_RAM_INSTALLED_ES, "Especificar tamano RAM instalada en KB (16/32/64)"},
...
/* es */ {IDCLS_SET_SATURATION_ES, "Seleccionar saturacion calculada en paleta interna [1000]"},
...
/* es */ {IDCLS_SET_ODDLINES_OFFSET_ES, "Seleccionar anadido fase trasporte color en lineas impares [750]"},
...
/* es */ {IDCLS_SET_SCANLINE_SHADE_ES, "Cantidad de lineas sombra escaneo para emulacion CRT [667]"},
...
/* es */ {IDCLS_SPECIFY_PRT_DRIVER_4_NAME_ES, "Especificar nombre controlador impresora periferico #4"},
...
/* es */ {IDCLS_SPECIFY_PRT_DRIVER_5_NAME_ES, "Especificar nombre controlador impresora periferico #5"},
...
/* es */ {IDCLS_SPECIFY_PRT_DRIVER_USR_NAME_ES, "Especificar nombre controlador impresion para puerto impresora"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_4_ES, "Seleccionar tipo para el periferico #4 (0:NO 1:FS, 2:REAL)"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_5_ES, "Seleccionar tipo para el periferico #5 (0:NO 1:FS, 2:REAL)"},
...
/* es */ {IDCLS_ENABLE_USERPORT_PRINTER_ES, "Permitir emulacion puerto impresora"},
...
/* es */ {IDCLS_DISABLE_USERPORT_PRINTER_ES, "Deshabilitar emulacion puerto impresora"},
...
/* es */ {IDCLS_SPECIFY_OUTPUT_DEVICE_4_NAME_ES, "Especificar nombre periferico de salida para periferico #4"},
...
/* es */ {IDCLS_SPECIFY_OUTPUT_DEVICE_5_NAME_ES, "Especificar nombre periferico de salida para periferico #5"},
...
/* es */ {IDCLS_SPECIFY_OUTPUT_DEVICE_USR_NAME_ES, "Especificar nombre periferico de salida para puerto usuario impresora"},
...
/* es */ {IDCLS_SPECIFY_TEXT_DEVICE_DUMP_NAME_ES, "Especificar nombre del periferico para imprimir texto o fichero de volcado"},
...
/* es */ {IDCLS_SPECIFY_TEXT_DEVICE_4_ES, "Especificar periferico salida impresion texto impresora #4"},
...
/* tr */ {IDCLS_SPECIFY_TEXT_DEVICE_4_TR, "Yazycy #4 icin metin cykty aygyty yazycysy belirt"},
#endif
...
/* es */ {IDCLS_SPECIFY_TEXT_DEVICE_5_ES, "Especificar periferico salida impresion texto impresora #5"},
...
/* tr */ {IDCLS_SPECIFY_TEXT_DEVICE_5_TR, "Yazycy #5 icin metin cykty aygyty yazycysy belirt"},
#endif
...
/* es */ {IDCLS_SPECIFY_TEXT_USERPORT_ES, "Especificar periferico de salida para imprimir texto impresora puerto usuario"},
...
/* es */ {IDCLS_ENABLE_VIDEO_CACHE_ES, "Permitier cache de video"},
...
/* es */ {IDCLS_DISABLE_VIDEO_CACHE_ES, "Deshabilitar cache de video"},
...
/* pl */ {IDCLS_DISABLE_VIDEO_CACHE_PL, "Wy3Å}cz cache wideo"},
...
/* es */ {IDCLS_SPECIFY_RS232_1_NAME_ES, "Especificar el nombre del primer periferico RS232"},
...
/* es */ {IDCLS_SPECIFY_RS232_2_NAME_ES, "Especificar el nombre del segundo periferico RS232"},
...
/* es */ {IDCLS_SPECIFY_RS232_3_NAME_ES, "Especificar el nombre del tercer periferico RS232"},
...
/* es */ {IDCLS_SPECIFY_RS232_4_NAME_ES, "Especificar el nombre del cuarto periferico RS232"},
...
/* es */ {IDCLS_SPECIFY_RS232_DEVICE_USERPORT_ES, "Especificar periferico VICE RS232 para puerto usuario"},
...
/* es */ {IDCLS_ENABLE_IEC_4_ES, "Permitir emulacion IEC para periferico #4 "},
...
/* es */ {IDCLS_DISABLE_IEC_4_ES, "Deshabilitar emulacion IEC para periferico #4 "},
...
/* es */ {IDCLS_ENABLE_IEC_5_ES, "Permitir emulacion IEC para periferico #5"},
...
/* es */ {IDCLS_DISABLE_IEC_5_ES, "Deshabilitar emulacion IEC para periferico #5"},
...
/* es */ {IDCLS_ENABLE_IEC_8_ES, "Permitir emulacion IEC para periferico #8"},
...
/* es */ {IDCLS_DISABLE_IEC_8_ES, "Deshabilitar emulacion IEC para periferico #8"},
...
/* es */ {IDCLS_ENABLE_IEC_9_ES, "Permitir emulacion IEC para periferico #9"},
...
/* es */ {IDCLS_DISABLE_IEC_9_ES, "Deshabilitar emulacion IEC para periferico #9"},
...
/* es */ {IDCLS_ENABLE_IEC_10_ES, "Permitir emulacion IEC para periferico #10"},
...
/* es */ {IDCLS_DISABLE_IEC_10_ES, "Deshabilitar emulacion IEC para periferico #10"},
...
/* es */ {IDCLS_ENABLE_IEC_11_ES, "Permitir emulacion IEC para periferico #11"},
...
/* es */ {IDCLS_DISABLE_IEC_11_ES, "Deshabilitar emulacion IEC para periferico #11"},
...
/* tr */ {IDCLS_ENABLE_SIDCART_TR, "SID kartutunu aktif et"},
#endif
...
/* tr */ {IDCLS_DISABLE_SIDCART_TR, "SID kartutunu pasiflettir"},
#endif
...
/* es */ {IDCLS_P_BASE_ADDRESS_ES, "<Direccion base>"},
...
/* es */ {IDCLS_SPECIFY_SID_2_ADDRESS_ES, "Especificar direccion base para el segundo ISD"},
...
/* de */ {IDCLS_SPECIFY_SID_3_ADDRESS_DE, "Basis Adresse fur dritten SID definieren"},
/* es */ {IDCLS_SPECIFY_SID_3_ADDRESS_ES, "Especificar direccion base para el tercer SID"},
...
/* pl */ {IDCLS_SPECIFY_SID_3_ADDRESS_PL, "OkreÅ˜l adres bazowy trzeciego SID-a"},
/* ru */ {IDCLS_SPECIFY_SID_3_ADDRESS_RU, ""},  /* fuzzy */
/* sv */ {IDCLS_SPECIFY_SID_3_ADDRESS_SV, "Ange basadress for tredje SID"},
/* tr */ {IDCLS_SPECIFY_SID_3_ADDRESS_TR, "3uncu SID icin taban adresini belirt"},
#endif
...
/* es */ {IDCLS_RESID_SAMPLING_METHOD_ES, "reSID metodo sampleado (0: rapido, 1: interpolacion, 2: resampelado, 3: resampleado rapido)"},
...
/* pl */ {IDCLS_PASSBAND_PERCENTAGE_PL, "Pasmo resamplowania reSID w procentach ca3kowitej przepustowoÅ˜ci (0 - 90)"},
...
/* es */ {IDCLS_ENABLE_STRETCH_VERTICAL_ES, "Permitir extension vertical adicional"},
...
/* tr */ {IDCLS_ENABLE_STRETCH_VERTICAL_TR, "Ek dikey uzatmayy aktif et."},
#endif
...
/* es */ {IDCLS_DISABLE_STRETCH_VERTICAL_ES, "Inhabilitar extension vertical adicional"},
...
/* tr */ {IDCLS_DISABLE_STRETCH_VERTICAL_TR, "Ek dikey uzatmayy pasiflettir."},
#endif
...
/* es */ {IDCLS_SET_VDC_MEMORY_16KB_ES, "Seleccionar tamano memoria VDC en 16KB"},
...
/* es */ {IDCLS_SET_VDC_MEMORY_64KB_ES, "Seleccionar tamano memoria VDC en 64KB"},
...
/* es */ {IDCLS_SET_VDC_REVISION_ES, "Poner revision VDC (0..2)"},
...
/* es */ {IDCLS_SPECIFY_MEMORY_CONFIG_ES, "Especificar configuracion de memoria"},
...
/* es */ {IDCLS_ENABLE_FINALEXPANSION_WRITEBACK_ES, "Permitir grabacion en fichero ROM Final Expansion"},
...
/* es */ {IDCLS_DISABLE_FINALEXPANSION_WRITEBACK_ES, "Deshabilitar grabacion en fichero ROM Final Expansion"},
...
/* es */ {IDCLS_DISABLE_MEGACART_NVRAM_WRITE_ES, "Deshabilitar grabacion en Mega-Cart NvRAM"},
...
/* es */ {IDCLS_SET_BORDER_MODE_ES, "Seleccionar VIC-II tipo de borde (0: normal, 1: completo, 2: depuracion)"},
...
/* es */ {IDCLS_ENABLE_SPRITE_BACKGROUND_ES, "Habilitar registros colision sprite-fondo"},
...
/* es */ {IDCLS_DISABLE_SPRITE_BACKGROUND_ES, "Deshabilitar registros colision sprite-fondo"},
...
/* es */ {IDCLS_ENABLE_SPRITE_SPRITE_ES, "Habilitar registros colision sprite-sprite"},
...
/* es */ {IDCLS_DISABLE_SPRITE_SPRITE_ES, "Deshabilitar registros colision sprite-sprite"},
...
/* es */ {IDCLS_ENABLE_DOUBLE_SIZE_ES, "Permitir tamano doble"},
...
/* es */ {IDCLS_DISABLE_DOUBLE_SIZE_ES, "Deshabilitar tamano doble"},
...
/* es */ {IDCLS_ENABLE_AUDIO_LEAK_ES, "Permitir emulacion audio leak"},
...
/* pl */ {IDCLS_ENABLE_AUDIO_LEAK_PL, "W3Å}cz emulacje brudow w d?wieku"},
/* ru */ {IDCLS_ENABLE_AUDIO_LEAK_RU, ""},  /* fuzzy */
/* sv */ {IDCLS_ENABLE_AUDIO_LEAK_SV, "Aktivera emulering av audiolackage"},
/* tr */ {IDCLS_ENABLE_AUDIO_LEAK_TR, "Ses kacady emulasyonunu aktif et"},
#endif
...
/* es */ {IDCLS_DISABLE_AUDIO_LEAK_ES, "Deshabilitar emulacion audio leak"},
...
/* pl */ {IDCLS_DISABLE_AUDIO_LEAK_PL, "Wy3Å}cz emulacje brudow w d?wieku"},
/* ru */ {IDCLS_DISABLE_AUDIO_LEAK_RU, ""},  /* fuzzy */
/* sv */ {IDCLS_DISABLE_AUDIO_LEAK_SV, "Inaktivera emulering av audiolackage"},
/* tr */ {IDCLS_DISABLE_AUDIO_LEAK_TR, "Ses kacady emulasyonunu pasiflettir"},
#endif
...
/* pl */ {IDCLS_ENABLE_HARDWARE_SCALING_PL, "W3Å}cz skalowanie sprzetowe"},
...
/* es */ {IDCLS_SET_VIDEO_FILTER_ES, "Seleccionar filtro de renderizador, 0:no, 1:emulacion CRT, 2: escala2x"},
...
/* tr */ {IDCLS_SET_VIDEO_FILTER_TR, "Goruntu olutturma filitresini sec, 0:yok, 1:CRT emulasyonu, 2: genitlet2x"},
#endif
...
/* es */ {IDCLS_P_DEVICE_ES, "<periferico>"},
...
/* es */ {IDCLS_SELECT_FULLSCREEN_DEVICE_ES, "Seleccionar periferico pantalla completa"},
...
/* es */ {IDCLS_SPECIFY_ACIA_RS232_DEVICE_ES, "Specificar periferico RS232 con el que funcionara esta ACIA"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_8_ES, "Seleccionar tipo para periferico #8  (0: NINGUNO, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_9_ES, "Seleccionar tipo para periferico #9  (0: NINGUNO, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_10_ES, "Seleccionar tipo para periferico #10  (0: NINGUNO, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_11_ES, "Seleccionar tipo para periferico #11  (0: NINGUNO, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* es */ {IDCLS_ATTACH_READ_ONLY_8_ES, "Insertar imagen disco solo lectura para unidad disco #8"},
...
/* es */ {IDCLS_ATTACH_READ_WRITE_8_ES, "Insertar imagen disco solo lectura/grabacion (si es posible) para unidad disco #8"},
...
/* es */ {IDCLS_ATTACH_READ_ONLY_9_ES, "Insertar imagen disco solo lectura para unidad disco #9"},
...
/* es */ {IDCLS_ATTACH_READ_WRITE_9_ES, "Insertar imagen disco solo lectura/grabacion (si es posible) para unidad disco #9"},
...
/* es */ {IDCLS_ATTACH_READ_ONLY_10_ES, "Insertar imagen disco solo lectura para unidad disco #10"},
...
/* es */ {IDCLS_ATTACH_READ_WRITE_10_ES, "Insertar imagen disco solo lectura/grabacion (si es posible) para unidad disco #10"},
...
/* es */ {IDCLS_ATTACH_READ_ONLY_11_ES, "Insertar imagen disco solo lectura para unidad disco #11"},
...
/* es */ {IDCLS_ATTACH_READ_WRITE_11_ES, "Insertar imagen disco solo lectura/grabacion (si es posible) para unidad disco #11"},
...
/* es */ {IDCLS_ENABLE_AUTO_DATASETTE_RESET_ES, "Permitir reinicio automatico de la unidad de cinta"},
...
/* es */ {IDCLS_DISABLE_AUTO_DATASETTE_RESET_ES, "Deshabilitar reinicio automatico de la unidad de cinta"},
...
/* es */ {IDCLS_SET_CYCLES_ADDED_GAP_TAP_ES, "Seleccionar numero ciclos anadidos en cada espacio en la cinta"},
...
/* es */ {IDCLS_TRACE_MODE_ES, "Modo de rastreo (0=normal, 1=pequeno, 2=historial)"},
...
/* es */ {IDCLS_REMOTE_MONITOR_ADDRESS_ES, "Direccion del monitor remoto al que se debe unir"},
...
/* es */ {IDCLS_CONSOLE_MODE_ES, "Modo consola (para reproduccion musica)"},
...
/* es */ {IDCLS_ALLOW_CORE_DUMPS_ES, "Permitir produccion volcados de nucleo"},
...
/* es */ {IDCLS_DONT_ALLOW_CORE_DUMPS_ES, "No permitir produccion volcados de nucleo"},
...
/* ru */ {IDCLS_RESTORE_DEFAULT_SETTINGS_RU, "2TaaaDYTOOai YDaaaTUUO sT aUTUcDYOi"},
...
/* es */ {IDCLS_SPECIFY_CONFIG_FILE_ES, "Especificar fichero de configuracion"},
...
/* pl */ {IDCLS_ENABLE_VERBOSE_LOG_OUTPUT_PL, "W3Å}cz szczego3owy zapis do loga"},
...
/* es */ {IDCLS_ENABLE_MOUSE_GRAB_ES, "Permitir captuar del raton"},
...
/* es */ {IDCLS_DISABLE_MOUSE_GRAB_ES, "Deshabilitar captura de raton"},
...
/* es */ {IDCLS_SELECT_MOUSE_JOY_PORT_ES, "Seleccionar el puerto de joystick en el que esta insertado el raton"},
...
/* es */ {IDCLS_SELECT_MOUSE_TYPE_ES, "Seleccionar tipo de raton  (0 = 1351, 1 = NEOS, 2 = Amiga, 3 = Paddles, 4 = CX-22, 5 = ST)"},
...
/* pl */ {IDCLS_SELECT_MOUSE_TYPE_PL, "Ustaw typ myszy (0 = 1351, 1 = NEOS, 2 = Amiga, 3 = pokret3a, 4 = CX-22, 5 = ST)"},
...
/* tr */ {IDCLS_SELECT_MOUSE_TYPE_TR, "Mouse tipini secin (0 = 1351, 1 = NEOS, 2 = Amiga, 3 = Paddles, 4 = CX-22, 5 = ST)"},
#endif
...
/* es */ {IDCLS_ENABLE_PS2MOUSE_ES, "Permitir raton PS/2 en puerto usuario"},
...
/* es */ {IDCLS_DISABLE_PS2MOUSE_ES, "Deshabilitar raton PS/2 en puerto usuario"},
...
/* es */ {IDCLS_SET_FIRST_RAM_ADDRESS_VALUE_ES, "Seleccionar el valor para la primera direccion RAM despues del encendido"},
...
/* es */ {IDCLS_P_NUM_OF_BYTES_ES, "<numero de bytes>"},
...
/* es */ {IDCLS_LENGTH_BLOCK_SAME_PATTERN_ES, "Longitud bloque memoria inicializado con el mismo patron"},
...
/* es */ {IDCLS_SET_SOUND_BUFFER_SIZE_MSEC_ES, "Seleccionar tamano bufer sonido en <valor>mseg"},
...
/* es */ {IDCLS_SET_SOUND_FRAGMENT_SIZE_ES, "Seleccionar tamano fragmento  (0 = pequeno, 1 = medio, 2 = grande)"},
...
/* es */ {IDCLS_SPECIFY_SOUND_DRIVER_PARAM_ES, "Especificar parametros de inicializacion para el controlador de sonido"},
...
/* es */ {IDCLS_SPECIFY_RECORDING_SOUND_DRIVER_ES, "Especificar controlador grabacion sonido"},
...
/* es */ {IDCLS_SPECIFY_REC_SOUND_DRIVER_PARAM_ES, "Especificar parametros inicializacion para el controlador grabacion sonido "},
...
/* es */ {IDCLS_ENABLE_TRAPS_FAST_EMULATION_ES, "Permitir mecanismos generales para emulacion rapida de cinta/disco"},
...
/* es */ {IDCLS_DISABLE_TRAPS_FAST_EMULATION_ES, "Deshabilitar mecanismos generales para emulacion rapida de cinta/disco"},
...
/* es */ {IDCLS_LIMIT_SPEED_TO_VALUE_ES, "Limitar la velocidad de emulacion al valor indicado"},
...
/* es */ {IDCLS_ENABLE_WARP_MODE_ES, "Permitir maxima velocidad"},
...
/* es */ {IDCLS_DISABLE_WARP_MODE_ES, "Desabilitar modo Ultrarapido"},
...
/* es */ {IDCLS_P_ISO_LANGUAGE_CODE_ES, "<codigo ISO idioma>"},
...
/* es */ {IDCLS_SPECIFY_ISO_LANG_CODE_ES, "Especificar el codigo ISO para el idioma"},
...
/* es */ {IDCLS_ENABLE_PLUS256K_EXPANSION_ES, "Permitir expansion RAM PLUS256K"},
...
/* pl */ {IDCLS_ENABLE_PLUS256K_EXPANSION_PL, "W3Å}cz rozszerzenie RAM PLUS256K"},
...
/* es */ {IDCLS_DISABLE_PLUS256K_EXPANSION_ES, "Deshabilitar expansion RAM PLUS256K"},
...
/* pl */ {IDCLS_DISABLE_PLUS256K_EXPANSION_PL, "Wy3Å}cz rozszerzenie RAM PLUS256K"},
...
/* es */ {IDCLS_ENABLE_PLUS60K_EXPANSION_ES, "Permitir expansion RAM PLUS60K"},
...
/* es */ {IDCLS_DISABLE_PLUS60K_EXPANSION_ES, "Deshabilitar expansion RAM PLUS60K"},
...
/* pl */ {IDCLS_DISABLE_PLUS60K_EXPANSION_PL, "Wy3Å}cz rozszerzenie RAM PLUS60K"},
...
/* es */ {IDCLS_PLUS60K_BASE_ES, "Direccion base de la expansion PLUS60K"},
...
/* es */ {IDCLS_ENABLE_C64_256K_EXPANSION_ES, "Permitir expansion RAM 256K"},
...
/* pl */ {IDCLS_ENABLE_C64_256K_EXPANSION_PL, "W3Å}cz rozszerzenie RAM 256K"},
...
/* es */ {IDCLS_DISABLE_C64_256K_EXPANSION_ES, "Deshabilitar expansion RAM 256K"},
...
/* pl */ {IDCLS_DISABLE_C64_256K_EXPANSION_PL, "Wy3Å}cz rozszerzenie RAM 256K"},
...
/* es */ {IDCLS_C64_256K_BASE_ES, "Direccion base de la expansion 256K"},
...
/* sv */ {IDCLS_ATTACH_RAW_SILVERROCK_128_CART_SV, "Anslut ra Silverrock 128-insticksmodulavbilding"},
/* tr */ {IDCLS_ATTACH_RAW_SILVERROCK_128_CART_TR, "Duz Silverrock 128 kartut imajy yerlettir"},
#endif
...
/* es */ {IDCLS_ENABLE_CS256K_EXPANSION_ES, "Permitir expansion RAM CSORY 256KB"},
...
/* pl */ {IDCLS_ENABLE_CS256K_EXPANSION_PL, "W3Å}cz rozszerzenie RAM CSORY 256K"},
...
/* es */ {IDCLS_ENABLE_H256K_EXPANSION_ES, "Permitir expansion RAM HANNES 256KB"},
...
/* pl */ {IDCLS_ENABLE_H256K_EXPANSION_PL, "W3Å}cz rozszerzenie RAM HANNES 256K"},
...
/* es */ {IDCLS_ENABLE_H1024K_EXPANSION_ES, "Permitir expansion RAM HANNES 1024KB"},
...
/* es */ {IDCLS_ENABLE_H4096K_EXPANSION_ES, "Permitir expansion RAM HANNES 4096KB"},
...
/* es */ {IDCLS_SPECIFY_DTV_REVISION_ES, "Especificar revision DTV (2: DTV2, 3: DTV3)"},
...
/* es */ {IDCLS_DISABLE_C64DTVROM_RW_ES, "Deshabilitar grabacion en imagen  C64DTV ROM"},
...
/* tr */ {IDCLS_DISABLE_C64DTVROM_RW_TR, "C64DTV ROM imajyna yazmayy pasiflettir"},
#endif
...
/* es */ {IDCLS_USE_AS_DIRECTORY_FLASH_FS_ES, "Usar <nombre> como directorio para periferico flash files system"},
...
/* es */ {IDCLS_ENABLE_MIDI_EMU_ES, "Habilitar emulacion MIDI"},
...
/* ru */ {IDCLS_ENABLE_MIDI_EMU_RU, "2UUicOai iUaUiaOi MIDI"},
...
/* es */ {IDCLS_DISABLE_MIDI_EMU_ES, "Deshabilitar emulacion MIDI"},
...
/* ko */ {IDCLS_ENABLE_SIDCARTJOY_KO, "SID AÅ·ARÅCRAo AÅ˜AI?oA? Å‚c?eCIÅ}a"},
...
/* ko */ {IDCLS_DISABLE_SIDCARTJOY_KO, "SID AÅ·ARÅCRAo AÅ˜AI?oA? Å‚c?eCIAo ?EÅ}a"},
...
/* tr */ {IDCLS_ENABLE_SFX_SE_TR, "SFX Sound Expander kartutunu aktif et"},
#endif
...
/* tr */ {IDCLS_DISABLE_SFX_SE_TR, "SFX Sound Expander kartutunu pasiflettir"},
#endif
...
/* ko */ {IDCLS_ENABLE_SFX_SS_KO, "SFX Sound Sampler AÅ·ARÅCRAo ÅC| AUÉ ??AA2ÅLU"},
...
/* es */ {IDCLS_ENABLE_LIGHTPEN_EMULATION_ES, "Permitir emulacion lapiz optico"},
...
/* es */ {IDCLS_DISABLE_LIGHTPEN_EMULATION_ES, "Deshabilitar emulacion lapiz optico"},
...
/* es */ {IDCLS_SET_LIGHTPEN_TYPE_ES, "Seleccionar tipo lapiz optico"},
...
/* es */ {IDCLS_DIGIMAX_BASE_ES, "Direccion base para cartucho DigMAX"},
